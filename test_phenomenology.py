...
def test_phenomenology_map():
    ...
    try:
        ...
        print(f"   Self-consistent representatives: {self_consistent}/{num_orbits} {'✅' if self_consistent == num_orbits else '❌'}")
        ...
        try:
            ...
            for i, idx in enumerate(test_indices):
                ...
                print(f"     {i+1:2d}. Index {idx:6d} → State 0x{state:012X} → Index {back_idx:6d} {status} (orbit: {orbit_card})")
