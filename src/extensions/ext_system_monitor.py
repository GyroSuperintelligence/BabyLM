...
class ext_SystemMonitor(GyroExtension):
    ...
    def get_health_report(self, phase: int, nav_log_size: int, 
                         knowledge_id: str, session_id: str) -> Dict[str, Any]:
        """
    ...
    def _validate_memory_bounds(self) -> bool:
        ...
        avg_memory = sum(self._performance_metrics['memory_usage']) / len(self._performance_metrics['memory_usage'])
    ...
    def _validate_performance_bounds(self) -> bool:
        ...
        avg_latency = sum(self._performance_metrics['operation_latency']) / len(self._performance_metrics['operation_latency'])
