...
from baby.governance import coadd
...
class TestPhenotypeRetrieval:
    ...
    def test_get_phenotype_existing(self, inference_engine):
        ...
        for key in ["phenotype", "memory_mask", "context_signature", "semantic_address", "usage_count", "age_counter", "confidence"]:
...
class TestLearningFunctionality:
    ...
    def test_learn_changes_mask(self, inference_engine):
        ...
        assert entry["memory_mask"] == coadd(intron1, intron2) & 0xFF
    ...
    def test_learn_no_change(self, inference_engine):
        ...
        # The mask should be coadd(intron, intron) & 0xFF
        expected_mask = coadd(intron, intron) & 0xFF
    ...
    def test_batch_learn_multiple(self, inference_engine, generate_test_introns):
        ...
        for i in introns[1:]:
            expected_mask = coadd(expected_mask, i & 0xFF) & 0xFF
        ...
        # The final memory mask inside the entry will be coadd(expected_mask, expected_mask) & 0xFF
        final_mask = coadd(expected_mask, expected_mask) & 0xFF
