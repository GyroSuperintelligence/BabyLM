...
from baby.types import PreferencesConfig
...
class TestMaintenanceTools:
    ...
    def test_merge_phenotype_maps(self, temp_dir):
        ...
        for strategy in strategies:
            ...
            # Verify merge worked
            result_store = PickleStore(dest_path)
            assert len(result_store.data) == 10  # 10 unique keys
            result_store.close()
    ...
    def test_apply_global_confidence_decay(self, temp_dir, mock_time):
        ...
        assert old_entry["confidence"] < 0.8
        store.close()
    ...
    def test_validate_manifold_integrity(self, manifold_data):
        ...
        assert "issues" in report["details"]
...
class TestEdgeCases:
    ...
    def test_missing_files(self, temp_dir):
        ...
        from baby.information import PickleStore
        store = PickleStore(missing_path)
...
class TestConfigurationAndPreferences:
    ...
    def test_canonical_storage_option(self, real_manifold, temp_dir):
        ...
        from baby.information import CanonicalizingStore
