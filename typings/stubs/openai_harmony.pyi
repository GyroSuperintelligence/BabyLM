...
class HarmonyEncoding:
    ...
    def render_conversation_for_completion(self, conversation: Conversation, next_turn_role: Role, config: RenderConversationConfig | None = None) -> list[int]: ...
    def render_conversation_for_training(self, conversation: Conversation, config: RenderConversationConfig | None = None) -> list[int]: ...
    def render_conversation(self, conversation: Conversation, config: RenderConversationConfig | None = None) -> list[int]: ...
...
class Message:
    ...
    def __init__(self, author: Optional[Author] = None, content: Union[str, List[TextContent], List[Any]] = None, **kwargs: Any) -> None: ...
    @classmethod
    def from_role_and_content(cls, role: Union[Role, RoleType, str], content: Union[str, SystemContent, DeveloperContent]) -> 'Message': ...
    @classmethod
    def from_author_and_content(cls, author: Author, content: Union[str, SystemContent, DeveloperContent]) -> 'Message': ...
