...
def full(size: Tuple[int, ...], fill_value: Union[int, float], dtype: Optional[dtype] = None, device: Optional[Union[device, str]] = None) -> Tensor: ...
def arange(start: Union[int, float], end: Optional[Union[int, float]] = None, step: Union[int, float] = 1, dtype: Optional[dtype] = None, device: Optional[Union[device, str]] = None) -> Tensor: ...
def cat(tensors: Sequence[Tensor], dim: int = 0) -> Tensor: ...
def topk(input: Tensor, k: int, dim: Optional[int] = None, largest: bool = True, sorted: bool = True) -> Tuple[Tensor, Tensor]: ...
